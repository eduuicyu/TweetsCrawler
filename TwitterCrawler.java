...
public class TwitterCrawler {
	...
	int retryCount = 0;
		...
		query.setUntil("2017-08-25");
		query.setSince("2017-08-24");
                QueryResult result;
		...
		retryCount++;
                LOG.log(Level.SEVERE, "Failed in searching tweets, sleeping", te);
		try{
			Thread.sleep(300000);//Sleep 5 min when rate limit has been reached.
	...
	System.out.println("Whole thing blows");
    }
